...
Planet.Ocean.Reaction.disequilibriumConcentrations = {"H2(aq)": np.nan, "CO2(aq)": np.nan, "Methane(aq)": np.nan}
Planet.Ocean.Reaction.useReferenceSpecies = True
Planet.Ocean.Reaction.referenceSpecies = 'CO2(aq)'
""" Layer step settings """
...
Planet.PfreezeUpper_MPa = 150.0
Planet.TfreezeUpper_K = 274.0
Planet.TfreezeRes_K = 0.005
Planet.PfreezeRes_MPa = 0.01
...
Planet.Core.rhoFe_kgm3 = 5150
Planet.Core.rhoFeS_kgm3 = 5150
Planet.Core.xFeS = 0
